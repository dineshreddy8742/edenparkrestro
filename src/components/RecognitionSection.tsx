...
export const RecognitionSection: React.FC = () => {
  ...
  return (
    <section id="recognition" className="py-12 sm:py-16 relative bg-[#FAF7F2] border-t border-[#E8DCB8] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        
        {/* Banner Card */}
        <div className="rounded-3xl p-5 sm:p-10 bg-white border border-[#E8DCB8] shadow-palace-card relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
            ...
            >
              ...
              <p className="text-leela-body text-xs sm:text-sm md:text-base font-normal leading-relaxed">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 pt-2">
                <div className="p-3.5 sm:p-4 rounded-2xl bg-[#FAF7F2] border border-[#E8DCB8]">
                  <div className="flex items-center gap-1 text-gold-600 mb-1">
                    <Star className="w-4 h-4 fill-gold-500 text-gold-500" />
                    <span className="font-mono font-bold text-base sm:text-lg text-leela-heading">4.8 / 5.0</span>
                  </div>
                  <div className="text-[11px] sm:text-xs text-leela-muted font-medium">Google Diner Rating</div>
                </div>

                <div className="p-3.5 sm:p-4 rounded-2xl bg-[#FAF7F2] border border-[#E8DCB8]">
                  <div className="font-mono font-bold text-base sm:text-lg text-gold-700 mb-1">
                    25,000+
                  </div>
                  <div className="text-[11px] sm:text-xs text-leela-muted font-medium">Patrons Welcomed</div>
                </div>

                <div className="p-3.5 sm:p-4 rounded-2xl bg-[#FAF7F2] border border-[#E8DCB8] col-span-2 sm:col-span-1">
                  <div className="font-mono font-bold text-base sm:text-lg text-emerald-700 mb-1">
                    100% Dual
                  </div>
                  <div className="text-[11px] sm:text-xs text-leela-muted font-medium">Dedicated Kitchens</div>
                </div>
              </div>

              {/* Key Distinctions checklist */}
              <div className="space-y-2 pt-2 text-xs sm:text-sm text-leela-body">
            ...
            <motion.div 
              ...
              viewport={{ once: true, margin: "100px" }}
              transition={{ duration: 0.25, ease: "easeOut" }}
              className="lg:col-span-5 bg-[#FAF7F2] border border-[#E8DCB8] rounded-3xl p-5 sm:p-7 space-y-5 sm:space-y-6 shadow-sm"
            >
                ...
                <div className="space-y-1.5 pt-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <a
                      ...
                      className="p-2.5 sm:p-3 rounded-xl bg-white hover:bg-[#FAF3E0] border border-[#DFCDAB] hover:border-gold-500 text-gold-900 font-mono text-xs font-bold flex items-center gap-2 transition-colors shadow-sm"
                    >
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-2.5 sm:gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex-1 py-3 sm:py-3.5 px-4 rounded-xl bg-gradient-to-r from-gold-600 to-gold-700 text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-gold-sm hover:shadow-gold-md transition-all cursor-pointer hover:scale-105"
                >
                ...
                <a
                  href="tel:+919603308999"
                  className="py-3 sm:py-3.5 px-4 rounded-xl border border-gold-400 bg-white hover:bg-[#FAF3E0] text-gold-900 text-xs font-bold uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5 shadow-sm cursor-pointer"
                >
